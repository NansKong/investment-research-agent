...
/**
 * Web search tool, backed by Tavily. This is the agent's primary way of
 * researching a company: recent news, financials commentary, competitive
 * landscape, leadership, controversies, etc. The agent decides what to
 * search for and how many times.
 */
export const webSearchTool = tool(
  ...
  },
  {
    name: "web_search",
    description:
      "Search the live web for up-to-date information about a company: news, financials, funding rounds, leadership, lawsuits, product launches, competitor moves, analyst opinions, etc. Use specific, targeted queries (e.g. 'Acme Corp Q2 2026 earnings revenue' rather than just 'Acme Corp').",
    schema: z.object({
...
export const stockQuoteTool = tool(
  ...
  },
  {
    name: "stock_quote",
    description:
      "Look up a best-effort, latest end-of-day stock quote (open/high/low/close/volume) for a US-listed ticker symbol. Only useful if you already know/suspect the ticker. Not reliable for OTC, private, or non-US companies — fall back to web_search for those.",
    schema: z.object({
...
export const allTools = [webSearchTool, stockQuoteTool];
